 ...
 */
class Version20180429140931 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE location CHANGE apartment apartment INT NOT NULL, CHANGE postcode postcode INT NOT NULL');
