 ...
 */
class Version20180512131921 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE activity ADD comment_count INT NOT NULL, ADD rating_count INT NOT NULL, ADD rating DOUBLE PRECISION NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE activity DROP comment_count, DROP rating_count, DROP rating');
    }
}
