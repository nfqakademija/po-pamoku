 ...
 */
final class Version20180602073750 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activity CHANGE comment_count comment_count INT DEFAULT NULL, CHANGE rating_count rating_count INT DEFAULT NULL, CHANGE rating rating DOUBLE PRECISION DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activity CHANGE comment_count comment_count INT NOT NULL, CHANGE rating_count rating_count INT NOT NULL, CHANGE rating rating DOUBLE PRECISION NOT NULL');
